...
import { Browser, OperatingSystem } from '@/assets/scripts/Utilities';
import { defineComponent, type PropType } from 'vue';
import type { ContextMenu, ContextMenuItem, ContextMenuSection } from "@/assets/scripts/Application";
